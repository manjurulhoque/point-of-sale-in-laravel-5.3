		...
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<tr><td>{{trans('item.inventory_to_add_subtract')}} *</td><td>{!! Form::text('in_out_qty', null, array('class' => 'form-control')) !!}</td></tr>
					<tr><td>{{trans('item.comments')}}</td><td>{!! Form::text('remarks', null, array('class' => 'form-control')) !!}</td></tr>
